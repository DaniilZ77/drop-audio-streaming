...
run: ### run app
	...
	-grpc_port localhost:50052 -user_history 30 -grpc_user_client_addr localhost:50051 -http_port localhost:8081 -log_level debug -cert ./tls/cert.pem \
	-key ./tls/key.pem -minio_password minioadmin -minio_user minioadmin \
	-minio_endpoint 192.168.0.111:9000 -minio_bucket drop-audio \
	-minio_use_ssl false -minio_location us-east-1 \
	-chunk_size 1024 -jwt_secret secret -upload_url_ttl 4320 \
	-grpc_client_retries 1 -grpc_client_timeout 2s
